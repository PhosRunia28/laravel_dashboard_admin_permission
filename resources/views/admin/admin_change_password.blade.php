                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{route("admin.password.update")}}" >  
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="old_password" class="form-control @error("old_password") is-invalid @enderror" id="old_password" autocomplete="off" placeholder="Old Password">
                            </div>
                            @error("old_password")
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="new_password" class="form-control @error("new_password") is-invalid @enderror" id="new_password" autocomplete="off" placeholder="New Password">
                            </div>
                            @error("new_password")
                                <span class="text-danger">{{$message}}</span>                                
                            @enderror
